...
if not re.fullmatch(r"\d+:[A-Za-z0-9_-]+", BOT_TOKEN):
    raise RuntimeError(
        "BOT_TOKEN is malformed. Remove spaces, quotes, and line breaks."
    )
...
def ban_user(user_id: int) -> None:
    """Ban a user for the current process."""
...
ALLOWED_KEYS = ["CPM-MAFIAx PRIMO-CPM"]
CHANNEL_ID = "-1003948068860"
CHANNEL_LINK = "https://t.me/cpmmafia"
...
if __name__ == "__main__":
    print("="*60)
    print("☠️☠️☠️ CPM-MAFIAx PRIMO-CPM TOOL BOT - CPM1 + CPM2 ULTIMATE ☠️☠️☠️")
    print("="*60)
    print("✅ Bot is running!")
    print("👑 Admins: 6531314640, 8650959684")
    print("🔑 Keys: CPM-MAFIAx PRIMO-CPM TOOL")
